...
void interpolateData(const std::vector<double>& vBase_times, std::vector<rs2_vector>& vInterp_data,
                     std::vector<double>& vInterp_times, const rs2_vector& prev_data, const double& prev_time);
...
int main(int argc, char** argv)
{
  ...
  auto imu_callback = [&](const rs2::frame& frame) {
    ...
    else if (rs2::motion_frame m_frame = frame.as<rs2::motion_frame>())
    {
      ...
      else if (m_frame.get_profile().stream_name() == "Accel")
      {
        ...
        // std::cout << "Accel:" << current_accel_data.x << ", " << current_accel_data.y << ", " << current_accel_data.z
        // << std::endl;
      }
    }
  };
  ...
  std::cout << " Coeff = " << intrinsics_left.coeffs[0] << ", " << intrinsics_left.coeffs[1] << ", "
            << intrinsics_left.coeffs[2] << ", " << intrinsics_left.coeffs[3] << ", " << intrinsics_left.coeffs[4]
            << ", " << std::endl;
  ...
  std::cout << " Coeff = " << intrinsics_right.coeffs[0] << ", " << intrinsics_right.coeffs[1] << ", "
            << intrinsics_right.coeffs[2] << ", " << intrinsics_right.coeffs[3] << ", " << intrinsics_right.coeffs[4]
            << ", " << std::endl;
...
#endif
      t_resize =
          std::chrono::duration_cast<std::chrono::duration<double, std::milli> >(t_End_Resize - t_Start_Resize).count();
