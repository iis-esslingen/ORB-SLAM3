This repo contains the implementation of ORB-SLAM3 ROS Wrapper.

<br/>

## Installation
See chapter `ORB-SLAM3-ROS` below to get information how to setup repository.

<details>
<summary><b>ORB-SLAM3-ROS</summary></br>
...
## Usage
Commands to launch application and services to save generated trajectory as well as map.
...
roslaunch orb_slam3_ros <launch_file> \
    ...
    do_save_map:=<do_save_map> map_file_name:=<map_file_name>
```
